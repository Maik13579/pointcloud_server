// From https://gitlab.kitware.com/keu-computervision/slam/-/blob/feat/ROS2/slam_lib/include/LidarSlam/RollingGrid.h?ref_type=heads
//==============================================================================
...
#include "pointcloud_server/KDTreePCLAdaptor.h"
